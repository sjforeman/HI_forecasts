...
OUTPUT_NOSUB="--output_root_directory ../output/specderivs/pkplot_cvnoise/withnoise/"
OUTPUT_NOTHERMALNOISE="--output_root_directory ../output/specderivs/pkplot_cvnoise/nothermalnoise/"
OUTPUT_NONOISE="--output_root_directory ../output/specderivs/pkplot_cvnoise/nonoise/"
...
PUMA32K_SURVEY="--HI --fsky 0.5 --Nside 256 --fill_factor 0.5 --dish_diameter 6.0 --hex_pack True --aperture_efficiency 0.7 --sky_coupling 0.9 --omt_coupling 0.9 --T_ground 300.0 --T_ampl 50.0 --remove_lowk_delta2_powspec"
PUMA5K_SURVEY="--HI --fsky 0.5 --Nside 100 --fill_factor 0.5 --dish_diameter 6.0 --hex_pack True --aperture_efficiency 0.7 --sky_coupling 0.9 --omt_coupling 0.9 --T_ground 300.0 --T_ampl 50.0 --remove_lowk_delta2_powspec"

CHORD_REDSHIFTS="0.25 3.75 7"
CHORD_SURVEY="--HI --fsky 0.5 --Nside 23 --fill_factor 1.0 --dish_diameter 6.0 --hex_pack False --aperture_efficiency 0.7 --sky_coupling 0.9 --omt_coupling 0.9 --T_ground 300.0 --T_ampl 30.0 --remove_lowk_delta2_powspec"
