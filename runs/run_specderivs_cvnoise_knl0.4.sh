...
OUTPUT_NOSUB_DIR=../output/specderivs/cvnoise/no_sub_knl0.4/
OUTPUT_SUB_DIR=../output/specderivs/cvnoise/sub_knl0.4/
...
PUMA32K_SURVEY="--HI --fsky 0.5 --Nside 256 --fill_factor 0.5 --t_int 5.0 --dish_diameter 6.0 --hex_pack True --aperture_efficiency 0.7 --sky_coupling 0.9 --omt_coupling 0.9 --T_ground 300.0 --T_ampl 50.0 --knl_z0 0.4 --dknl_dz 0.0 --dknl_dDinv 0.0 --remove_lowk_delta2_powspec --kmax 3.0"
PUMA5K_SURVEY="--HI --fsky 0.5 --Nside 100 --fill_factor 0.5 --t_int 5.0 --dish_diameter 6.0 --hex_pack True --aperture_efficiency 0.7 --sky_coupling 0.9 --omt_coupling 0.9 --T_ground 300.0 --T_ampl 50.0 --knl_z0 0.4 --dknl_dz 0.0 --dknl_dDinv 0.0 --remove_lowk_delta2_powspec --kmax 3.0"
...
CHORD_SURVEY="--HI --fsky 0.5 --Nside 23 --fill_factor 1.0 --t_int 5.0 --dish_diameter 6.0 --hex_pack False --aperture_efficiency 0.7 --sky_coupling 0.9 --omt_coupling 0.9 --T_ground 300.0 --T_ampl 30.0 --knl_z0 0.4 --dknl_dz 0.0 --dknl_dDinv 0.0 --remove_lowk_delta2_powspec --kmax 3.0"
