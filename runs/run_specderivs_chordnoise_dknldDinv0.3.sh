...
OUTPUT_NOSUB_DIR=../output/specderivs/chordnoise/no_sub_dknldDinv0.3/
OUTPUT_SUB_DIR=../output/specderivs/chordnoise/sub_dknldDinv0.3/
...
PUMA32K_SURVEY="--HI --fsky 0.5 --Nside 256 --fill_factor 0.5 --t_int 5.0 --dish_diameter 6.0 --hex_pack True --aperture_efficiency 0.7 --sky_coupling 1 --omt_coupling 1 --T_ground 0 --T_ampl 30.0 --knl_z0 0.0 --dknl_dz 0.0 --dknl_dDinv 0.3 --remove_lowk_delta2_powspec --kmax 3.0"
PUMA5K_SURVEY="--HI --fsky 0.5 --Nside 100 --fill_factor 0.5 --t_int 5.0 --dish_diameter 6.0 --hex_pack True --aperture_efficiency 0.7 --sky_coupling 1 --omt_coupling 1 --T_ground 0 --T_ampl 30.0 --knl_z0 0.0 --dknl_dz 0.0 --dknl_dDinv 0.3 --remove_lowk_delta2_powspec --kmax 3.0"
...
CHORD_SURVEY="--HI --fsky 0.5 --Nside 23 --fill_factor 1.0 --t_int 5.0 --dish_diameter 6.0 --hex_pack False --aperture_efficiency 0.7 --sky_coupling 1 --omt_coupling 1 --T_ground 0 --T_ampl 30.0 --knl_z0 0.0 --dknl_dz 0.0 --dknl_dDinv 0.3 --remove_lowk_delta2_powspec --kmax 3.0"
